<html>
<head><title>Add/Substract Money</title>
    <style>
        form{
  ...
  width: 10%;
    ...
    <p><font size="6">Add/Substract Money</font></p>
</head>
<body>
 ...
 session_start();
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $bal = mysqli_real_escape_string($db,$_POST['bal']);
       ...
       $sql = "UPDATE `details` SET `balance`=`balance` - '$bal' WHERE `username` = '$myusername' " ;
